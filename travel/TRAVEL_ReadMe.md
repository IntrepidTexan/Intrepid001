...
| Latitude | Longitude | Country | Location / Description | Filename |
|---:|---:|---|---|---|
...
5. Add a new row to the `current` worksheet using this fixed column order:
   - Column A: Latitude
   - Column B: Longitude
   - Column C: Country
   - Column D: Location / Description
   - Column E: Exact photo filename
6. Save the workbook.
...
```text
IT_travel_photodata.xlsx -> Column E
```
...
Approximate locations should be identified in the Location / Description field with wording such as:
